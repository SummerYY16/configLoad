...
// SetRollingDaily SetRollingDaily
...
func Printf(format string, v ...interface{}) {
	...
	console(fmt.Sprintf(format, v...))
}

// PrintfTest PrintfTest
func PrintfTest(format string, v ...interface{}) {
...
func Println(v ...interface{}) {
	...
	if logObj != nil {
		logObj.lg.Output(2, fmt.Sprintln(v...))
	}
	console(v)
}
